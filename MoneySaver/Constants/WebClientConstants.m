//
//  WebClientConstants.m
//  MoneySaver
//
//  Created by Tbxark on 15/9/22.
//  Copyright © 2015年 TBXark. All rights reserved.
//

#import "WebClientConstants.h"

NSString * const kNetResponeStateCode = @"errCode";
NSString * const kNetResponeResultKey = @"result";
NSString * const kNetResponeErrorKey  = @"errMsg";
